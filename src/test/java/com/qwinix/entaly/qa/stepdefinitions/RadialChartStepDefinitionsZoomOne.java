...
import com.qwinix.entaly.qa.steps.RadialChartStepsZoomOne;
...
public class RadialChartStepDefinitionsZoomOne
{
	public WebDriver driver=StepsDefinitions.driver;
	UserSteps objUserSteps = new UserSteps();
	RadialChartStepsZoomOne radialzoomone = new RadialChartStepsZoomOne();
	...
	{
		radialzoomone.RadialAccessToken();
	}
	...
	{
		radialzoomone.RadialchartOnmouseover();
	}
}