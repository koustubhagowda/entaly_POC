...
import com.qwinix.entaly.qa.steps.RadialChartStepsZoomThree;
...
public class RadialChartStepDefinitionsZoomThree
{
	public WebDriver driver=StepsDefinitions.driver;
	UserSteps objUserSteps = new UserSteps();
	RadialChartStepsZoomThree radialzoomthree = new RadialChartStepsZoomThree();
	...
	{
		radialzoomthree.radialZoom3AccessToken();
	}
	...
	{
		radialzoomthree.zoom3radialgraph();
	}
